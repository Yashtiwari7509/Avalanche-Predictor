...
const formSchema = z.object({
  ...
  elevation: z.coerce
    .number()
    .min(500, "Elevation must be at least 500m")
    .max(5000, "Elevation must be less than 5000m"),
  slope: z.coerce
    .number()
    .min(0, "Slope must be at least 0°")
    .max(90, "Slope must be less than 90°"),
  ...
  temperature: z.coerce
    ...
    .max(20, "Temperature must be below 20°C"),
        ...
        <Form {...form}>
          ...
          >
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select value={field.value} onValueChange={field.onChange}>
                      <FormControl>
                        <SelectTrigger className="text-black bg-transparent">
                      ...
                      <SelectContent>
                        {locations.map((location) => (
                          <SelectItem
                            key={location.id}
                            value={String(location.id)} // force type match
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        {["poor", "moderate", "good", "excellent"].map(
                          (visibility) => (
            ...
            <CardFooter className="px-0 pt-2">
              <Button type="submit" className="w-full bg-sky-600 hover:bg-sky-400 font-semibold transition-all duration-300" disabled={isLoading}>
                {isLoading ? "Analyzing..." : "Predict Avalanche"}
              </Button>
            </CardFooter>
          </form>
        </Form>
